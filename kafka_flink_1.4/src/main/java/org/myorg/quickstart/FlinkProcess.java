...
public class FlinkProcess {
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("bootstrap.servers", "ec2-34-218-113-11.us-west-2.compute.amazonaws.com:9092");
        properties.setProperty("zookeeper.connect", "ec2-34-218-113-11.us-west-2.compute.amazonaws.com:2181");
        //properties.setProperty("group.id", "flink_consumer");


        // read 'topic' from Kafka producer: Kafka topic is "wikiInput"
        FlinkKafkaConsumer010<String> kafkaConsumer = new FlinkKafkaConsumer010<String>("test-topic",
